...
DATABASE_URL = os.environ.get("mongodb+srv://ego:Egobeyler99@cluster0.p00hwbq.mongodb.net/?retryWrites=true&w=majority") # MongoDB veritabanınızın url'si. Nasıl alacağınızı bilmiyorsanız destek grubu @RepoHaneX'e gelin.
BOT_USERNAME = os.environ.get("broadcasttest1_bot") # Botunuzun kullanıcı adı.
LOG_CHANNEL = int(os.environ.get("-1001984763255")) # Botunuzun eylemleri kaydedeceği kayıt grubunun id'si.
...
OWNER_ID = int(os.environ.get("1205219610")) # Sahip hesabın id'si
